...
$ curl -X POST -d "{\"level\":\"info\",\"ident\":\"1234\",\"is_check\":\"true\",\"object\":\"Poveleck\",\"source\":\"systemS\",\"body\":\"body1\", \"cmd\":\"ins_evnt\"}" -H "Content-Type: application/json" http://localhost:8085/json
